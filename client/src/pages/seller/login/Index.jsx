...
const Index = () => {
    ...
    const handleSubmit =async(e)=>{
        e.preventDefault()
        try {
            const res = await axios.post("http://localhost:8080/api/v1/auth/seller-login",{email,password})
            const {data} =res;
  ...
  return (
    <section className='pt-[124px] pb-[140px]'>
        <div className='w-container mx-auto'>
            <h3 className='text-[#262626] font-DM text-[49px] font-bold'>Seller Login</h3>
            ...
            <h3 className='text-[#262626] font-DM text-[39px] font-bold mt-[57px]'></h3>
            <div className=' '>
        ...
        <h3 className='text-[#262626] font-DM text-[39px] font-bold'>Become a Seller</h3>
        ...
        <button className='mt-[67px] py-4 px-20 text-[#fff] font-DM text-base font-bold border bg-[#2B2B2B] border-[#2B2B2B]' onClick={()=>navigate('/seller-register')}>Continue</button>
        </div>
    </section>
  )
}
